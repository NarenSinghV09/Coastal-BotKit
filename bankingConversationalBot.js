...
var botName = "Banking Virtual Assist";
...
module.exports = {
    ...
    on_bot_message  : function(requestId, data, callback) {
        ...
        if(!["AnythingElseDialog","Followups","Feedback"].includes(data.context.intentName) && data.context.session.BotUserSession.isRepeatEnabled){
